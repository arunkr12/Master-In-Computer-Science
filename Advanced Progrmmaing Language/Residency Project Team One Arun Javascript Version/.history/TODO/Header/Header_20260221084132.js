        ...
        <div class="container">
          <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem;">
            <div style="display:flex; align-items:center; gap:0.75rem; flex:1;">
              <div style="font-size:0.75rem; color: rgba(255,255,255,0.9);">LOGGED IN AS</div>
            ...
            <div style="display:flex; align-items:center; justify-content:flex-end; flex:1;">
              <select class="user-selector" style="padding: 0.4rem 0.6rem; border-radius: 6px; border: none; background: white; color: #333; font-weight: bold; cursor: pointer;">
                ${this.users
                  .map(
                    (user) => `
