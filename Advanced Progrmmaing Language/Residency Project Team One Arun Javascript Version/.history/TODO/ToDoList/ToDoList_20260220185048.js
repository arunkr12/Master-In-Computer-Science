class ToDoList {
  ...
  render() {
    ...
    const completionPercentage = this.todos.length > 0 ? Math.round((completedCount / this.todos.length) * 100) : 0;
      ...
      <div class="card shadow-lg border-0" style="border-radius: 8px;">
        <div class="card-header bg-gradient p-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px 8px 0 0;">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-light text-dark" style="font-size: 0.85rem; padding: 5px 12px;">
