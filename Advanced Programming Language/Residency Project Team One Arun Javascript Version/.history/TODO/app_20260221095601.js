...
function setupEventListeners() {
  ...
  if (userSelector) {
    userSelector.addEventListener("change", async (e) => {
      const userId = parseInt(/** @type {HTMLSelectElement} */ (e.target).value);
  ...
  const inputField = /** @type {HTMLInputElement} */ (document.querySelector(".add-todo-input"));
  const assignedToSelect = /** @type {HTMLSelectElement} */ (document.querySelector(".task-assigned-to"));
  const categorySelect = /** @type {HTMLSelectElement} */ (document.querySelector(".task-category"));
  const prioritySelect = /** @type {HTMLSelectElement} */ (document.querySelector(".task-priority"));
  ...
  editButtons.forEach((btn) => {
    btn.addEventListener("click", (e) => {
      ...
      const textSpan = /** @type {HTMLElement} */ (row.querySelector(".todo-text"));
      if (!textSpan) return;
