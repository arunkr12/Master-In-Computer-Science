      ...
      <div class="card shadow-lg border-0" style="border-radius: 8px; margin-bottom: 1rem;">
        ...
        <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 0 0 8px 8px;">
          <div class="row g-2 mb-3">
            <div class="col-4">
              <div style="background: white; border-radius: 6px; border: 1px solid #e9ecef; padding: 1rem; text-align: center;">
                <div style="font-size: 1.1rem; color: #667eea; font-weight: bold;">${this.todos.length}</div>
                <div style="font-size: 0.75rem; color: #666; margin-top: 0.5rem;">Total Tasks</div>
              </div>
            </div>
            <div class="col-4">
              <div style="background: white; border-radius: 6px; border: 1px solid #e9ecef; padding: 1rem; text-align: center;">
                <div style="font-size: 1.1rem; color: #28a745; font-weight: bold;">✅ ${completedCount}</div>
                <div style="font-size: 0.75rem; color: #666; margin-top: 0.5rem;">Completed</div>
              </div>
            </div>
            <div class="col-4">
              <div style="background: white; border-radius: 6px; border: 1px solid #e9ecef; padding: 1rem; text-align: center;">
                <div style="font-size: 1.1rem; color: #ffc107; font-weight: bold;">⏳ ${pendingCount}</div>
                <div style="font-size: 0.75rem; color: #666; margin-top: 0.5rem;">Pending</div>
              </div>
            </div>
          </div>
          <div style="background: white; border-radius: 6px; padding: 1rem; overflow-y: auto; min-height: 300px; max-height: 500px;">
