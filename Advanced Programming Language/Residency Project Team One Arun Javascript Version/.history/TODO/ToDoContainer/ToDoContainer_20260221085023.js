...
class ToDoContainer {
  ...
  setSelectedCategory(categoryId) {
    this.selectedCategoryId = categoryId && categoryId !== 0 ? categoryId : null;
    if (this.category && typeof this.category.setCurrentCategory === "function") {
