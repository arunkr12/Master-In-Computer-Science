  ...
  async deleteTodoItem(id) {
    ...
    try {
      ...
      if (success) {
        ...
        this.concurrencyManager.logChange(id, 'DELETE', this.currentUserId, todo, null);
      ...
      alert(`⚠️ Failed to delete task. It may have been modified or deleted by another user.`);
      await this.refreshLocalTodos();
      return false;
    }
    return false;
