      ...
      <header class="bg-gradient-primary text-white py-3 shadow-lg" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="container">
          <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem;">
            <div style="display:flex; align-items:center; gap:0.75rem; flex:0 0 220px;">
            ...
            <div style="display:flex; align-items:center; justify-content:flex-end; flex:0 0 220px;">
              <select class="user-selector" style="padding: 0.35rem 0.6rem; border-radius: 6px; border: none; background: white; color: #333; font-weight: bold; cursor: pointer; min-width:120px;">
                ${this.users
                  .map(
                    (user) => `
